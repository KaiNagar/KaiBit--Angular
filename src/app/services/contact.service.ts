...
export class ContactService {
  //mock the server
  private _contactsDb: Contact[] = this.setContacts();
  ...
  private setContacts() {
    let contacts = this.UtilService.loadFromStorage(CONTACT_KEY);
    if (!contacts && !contacts?.length) {
      contacts = CONTACTS;
      this.UtilService.saveToStorage(CONTACT_KEY, contacts);
    }
    return contacts;
  }
  ...
  public deleteContact(id: string) {
    ...
    this.UtilService.saveToStorage(CONTACT_KEY, this._contactsDb);
  }
